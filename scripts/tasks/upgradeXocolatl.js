...
const upgradeXocolatl = async () => {
    ...
    await upgrades.validateUpgrade(await xoc.getAddress(), contractArtifact, proxyOpts);
    const implementation = await upgrades.prepareUpgrade(await xoc.getAddress(), contractArtifact, proxyOpts);
