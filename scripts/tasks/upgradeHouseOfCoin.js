const {getContract, updateDeployments} = require("../utils");
...
const upgradeHouseOfCoin = async () => {
    ...
    await upgrades.validateUpgrade(await coinhouse.getAddress(), contractArtifact, proxyOpts);
    const implementation = await upgrades.prepareUpgrade(await coinhouse.getAddress(), contractArtifact, proxyOpts);
